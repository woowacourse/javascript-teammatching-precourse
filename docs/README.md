...
이 프로그램은 크루 관리와 팀 매칭 서비스를 제공해주는 프로그램입니다.😀

만약, 크루를 관리해야하거나 팀 매칭이 필요한 사람이라면 누구나 이 프로그램을 사용하 실 수 있습니다.
...
**추가적으로 필요한 기능이나 오류는 ssmin940606@gmail.com으로 알려주시면 감사하겠습니다.**
