...
- 우아한테크코스 웹 프론트엔드 최종 코딩 테스트
- 크루 관리 & 팀 매칭 시스템을 구현합니다.
- 이 문서는 ‘주어진 조건’ 및 ‘조건에 따른 기능 구현’ 내용을 담고있습니다.
...
- 백엔드 크루와 프론트엔드 크루 중 선택 가능하다.
- 입력한 이름이 공백이 아닌지 확인한다.
- 입력한 이름이 5글자 이하인지 확인한다.
- 입력받은 크루 이름을 목록에 추가한다.
- 추가된 크루는 삭제 가능하다.
- 삭제시 confirm을 이용하여 한번 더 확인한다.
- 크루 table의 첫번째 열에는 index를 1부터 넣어 순서를 표시한다.

### **🔵** 팀 관리

- 코스와 미션, 그리고 1팀당 인원 수를 입력하여 무작위로 매칭한다.
- 입력한 인원 수가 해당 코스 총 인원수 이하여야 한다.
- 해당 코스 인원을 입력 인원으로 나눴을 때 떨어지지 않는다면 남은 인원을 앞 팀부터 순서대로 배정한다.
- 팀 매칭 결과는 쉼표로 구분한다.
...
![https://github.com/moonnew/javascript-teammatching-precourse/raw/main/images/crew_result.png](https://github.com/moonnew/javascript-teammatching-precourse/raw/main/images/crew_result.png)

![https://github.com/moonnew/javascript-teammatching-precourse/raw/main/images/crew_result.gif](https://github.com/moonnew/javascript-teammatching-precourse/raw/main/images/crew_result.gif)

### **2) 팀 매칭 관리**

![https://github.com/moonnew/javascript-teammatching-precourse/raw/main/images/team_result.png](https://github.com/moonnew/javascript-teammatching-precourse/raw/main/images/team_result.png)

![https://github.com/moonnew/javascript-teammatching-precourse/raw/main/images/team_result.gif](https://github.com/moonnew/javascript-teammatching-precourse/raw/main/images/team_result.gif)
