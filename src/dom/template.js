...
<section id="crew-manage-section">
  <h3 id="end-crew-title">프론트엔드 크루 관리</h3>
  <form>
    <label>크루 이름</label>
...
<section id="crew-list-section">
  <h3 id="end-crew-list">프론트엔드 크루 목록</h3>
...
export const FrontendcrewListTable = `<tr class="front-crew-member">
<td></td>
<td></td>
<td>
...
export const backendCrewListTable = `<tr class="back-crew-member">
<td></td>
<td></td>
<td>
<button id="delete-crew-buttton">삭제</button>
